...
/****** Object:  StoredProcedure [dbo].[sp_Create_dwh_dimensions]    Script Date: 2026/07/24 21:13:20 ******/
SET ANSI_NULLS ON
GO
...
CREATE   PROCEDURE [dbo].[sp_Create_dwh_dimensions]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        CREATE TABLE dbo.dwh_dim_store
        (
    ...
    BEGIN
        CREATE TABLE dbo.dwh_dim_payment
        (
    ...
    BEGIN
        CREATE TABLE dbo.dwh_dim_cashier
        (
